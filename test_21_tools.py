...
test("memory_search - 综合检索", lambda: (
    ok(isinstance(memory_search(query="云计算 预算"), dict))
))

test("memory_stats - 统计信息", lambda: (
...
test("memory_health - 健康检查", lambda: (
